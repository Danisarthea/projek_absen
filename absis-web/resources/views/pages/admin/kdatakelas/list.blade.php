...
<div class="container"> 
  <div class="page-inner"> 
    ...
    <form action="{{ isset($kelasEdit) ? route('list_kelas.update', $kelasEdit->id) : route('list_kelas.store') }}" method="POST"> 
      @csrf
      @if(isset($kelasEdit))
          @method('PUT')
      @endif
              ...
              <tbody>
                @foreach ($kelas as $kel)
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="{{ route('list_kelas.show', $kel->id) }}" class="btn btn-info"><i class="far fa-eye"></i></a>
                      <a href="{{ route('list_kelas.edit', $kel->id) }}" class="btn btn-primary"><i class="far fa-edit"></i></a>
                      <form action="{{ route('list_kelas.destroy', $kel->id) }}" method="post" class="d-inline">
                          @csrf
                          @method('DELETE')
