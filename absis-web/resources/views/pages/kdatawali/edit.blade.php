        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form class="col-6" action="/list_wali/{{ $wali->id }}" method="POST" enctype="multipart/form-data">
                    @method('put')
                      @csrf
                      ...
                      <div class="form-group">
                        ...
                        <select id="wali_kelas" name="wali_kelas" class="form-control" name="wali_kelas" value="{{ old('wali_kelas') ?? $wali->wali_kelas }}" required>
                            <option value="{{ old('wali_kelas') ?? $wali->wali_kelas}}"></option>
