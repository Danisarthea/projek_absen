      ...
      <div class="col-md-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between">
                  ...
                  <a href="<?php echo e(route('pages.kdatakelas.list')); ?>" class="btn btn-primary">Kembali</a>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\absis-web\resources\views\pages\kdatakelas\tambahsiswa.blade.php ENDPATH**/ ?>