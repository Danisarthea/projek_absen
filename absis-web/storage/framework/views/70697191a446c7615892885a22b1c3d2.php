                  ...
                  <div class="card-body">
                    ...
                    <form class="col-6" action="/list_wali" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama" class="form-control" name="nama" value="<?php echo e(old('nama')); ?>" required>
                            <span><?php echo e($errors->first('nama')); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="wali_kelas">Wali Kelas</label>
                            <select id="wali_kelas" name="wali_kelas" class="form-control" name="wali_kelas" value="<?php echo e(old('wali_kelas')); ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="kontak" class="form-control" name="kontak" value="<?php echo e(old('kontak')); ?>" required>
                        ...
                        <div class="form-group d-flex flex-column">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="laki_laki" name="jenis_kelamin" value="laki-laki" <?php echo e(old('jenis_kelamin') === 'laki-laki' ? 'checked' : ''); ?>>
                                <label for="no_pasien">Laki-laki</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="perempuan" name="jenis_kelamin" value="perempuan" <?php echo e(old('jenis_kelamin') === 'perempuan' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\absis-web\resources\views\pages\kdatawali\tambah.blade.php ENDPATH**/ ?>