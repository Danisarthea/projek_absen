                    ...
                    <!-- start tombol konfirmasi -->
                        <div class="row">
                            <div class="col-3 col-sm-3 ms-4">
                                <a href="<?php echo e(route('pages.verifikasi.antriverifikasi')); ?>" class="btn btn-primary my-2" style="width: 225px;">Setuju</a><br>
                                <a href="<?php echo e(route('pages.verifikasi.antriverifikasi')); ?>" class="btn btn-danger" style="width: 225px;">Tidak Setuju</a>
                            </div>
...
<?php echo $__env->make('components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\absis-web\resources\views\pages\verifikasi\verifikasi.blade.php ENDPATH**/ ?>