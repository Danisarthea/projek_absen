        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item <?php echo e(\Route::is('/list_siswa') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('list_siswa.index')); ?>">
                  <i class="fas fa-user"></i>
                  <span class="sub-item">Data Siswa</span>
                </a>
              </li><li class="nav-item <?php echo e(\Route::is('/list_wali') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('list_wali.index')); ?>">
                  <i class="fas fa-user-tie"></i>
                  <span class="sub-item">Data Wali Kelas</span>
                </a>
              </li><li class="nav-item <?php echo e(\Route::is('/list_kelas') ? 'active' : ''); ?>">
